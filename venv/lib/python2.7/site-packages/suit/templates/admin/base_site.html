...
{% block footer_links %}
	<a href="/docs/" class="icon"><i class="icon-question-sign"></i>Documentación</a>
{% endblock %}
...
{% block copyright %}
	Derechos Reservados &copy; 2015 Avanzando Juntos<br>Desarrolado por <a href="http://compupz.com" target="_blank">CompuPZ</a>
{% endblock %}
