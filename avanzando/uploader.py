...
def main():
	...
	try:
		with open ("./db_backup/"+ datetime.datetime.today().strftime("%Y%m%d") + ".tar"): pass #check existance of while
		print "Uploading started..."
		print client.put_file("/db_backup/" + datetime.datetime.today().strftime("%Y%m%d") + ".tar", open ("./db_backup/"+ datetime.datetime.today().strftime("%Y%m%d") + ".tar"))
